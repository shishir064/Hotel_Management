                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span id="totalPrice" data-price="{{ $finalPrice }}"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
                            ...
                            <div class="mt-6 p-4 bg-gray-100 rounded-xl">
                                <div class="grid md:grid-cols-2 gap-5">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Booked Date</label>
                                        <input type="date" name="booked_date"
                                            value="{{ old('booked_date', now()->format('Y-m-d')) }}"
                                            class="w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition " required>
