...
<form action="">
    <div>
        ...
        <p class="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">Fill in the details carefully and accurate room details, pricing, and amenities, to enhance the user booking experience.</p>
    </div>
    ...
    <div class="">
        ...
        <div class="grid grid-cols-2 sm:flex gap-4 flex-wrap my-2 ">
            ...
            <label for="roomImg3" >
                <img class="max-h-13 cursor-pointer opencity-80" src="{{asset('images/imgUpload.svg')}}" alt="">
    ...
    <div class="flex mt-4 gap-x-2">
        ...
        <div>
            ...
            <input type="number" placeholder="0" value="0" class="py-2 px-2 rounded border border-gray-300 text-gray-500 max-w-12">
        </div>
    </div>
    <div class="text-gray-400">
        ...
        <div>
            <input type="checkbox" name="" id="Gym" value="Gym">
