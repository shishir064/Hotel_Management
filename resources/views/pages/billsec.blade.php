    ...
    <div class="max-w-4xl mx-auto p-6">
                    ...
                    <tbody id="billTable">
                        ...
                        @foreach ($services as $service)
                            <tr>
                                ...
                                <td class="border border-gray-200 px-1.5 py-0.5 text-center">
                                    1
                                </td>

                                <td class="border border-gray-200 px-1.5 py-0.5 text-right">
                                ...
                                <td class="border border-gray-200 px-1.5 py-0.5 text-right">
                                    <span class="cell-input">{{ number_format($service->price, 2) }}</span>
                                </td>
                    ...
                    <table class="border-collapse w-full">
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-200 px-2 py-1">
                                <input id="discount" class="sum-input" name="discount" value="{{ $bill->discount }}"
                        ...
                        <tr>
                            <td
                                ...
                                VAT (%)</td>
                            <td class="border border-gray-200 px-2 py-1">
                                <input id="tax" class="sum-input" name="vat" value="{{ $bill->vat }}"
                                    oninput="calculateTotal()">
                            </td>
                        </tr>
                        <tr class="bg-gray-100">
                            ...
                            <td class="border border-gray-300 px-2 py-1.5"><input id="grandTotal"
                                    class="sum-input font-bold" value="{{ $bill->total }}" readonly placeholder="0.00">
                            </td>
                        </tr>
                        <tr>
                            <td
        ...
        <div class="no-print max-w-3xl mx-auto mt-4 grid grid-cols-3 gap-3">
            ...
            <div>
                ...
                <textarea rows="2" name="remarks" value="{{ $bill->remarks }}"
                    class="w-full border border-gray-300 rounded-md px-2 py-1.5 text-sm text-gray-800 resize-y"></textarea>
            </div>
        </div>
