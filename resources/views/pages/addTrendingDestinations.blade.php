...
@section('content')
    <div class="w-full mx-auto bg-gray-50 shadow  p-6 rounded-lg ">
        ...
        <h2 class="text-xl font-semibold mb-6">Add Trending Destination</h2>
        <form action="{{ route('trending-destinations.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <!-- featured destination Name -->
            <div class="mb-4">
                <label class="block mb-1 font-medium">Trending Destination Name</label>
            ...
            <!-- Cover_image -->
            <div class="mb-4">
                <label class="block mb-1 font-medium">Trending Destination Cover Image</label>
